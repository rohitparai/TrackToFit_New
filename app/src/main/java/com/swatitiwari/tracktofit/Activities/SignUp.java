...
import com.swatitiwari.tracktofit.Common.Constants;
    ...
    class RegisterUserTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (isOkay){
                ...
                sharedPref.setUser(SignUp.this,user);
                Intent intent = new Intent(SignUp.this, BMICalculator.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }else{
                Toast.makeText(SignUp.this, "This email is already using by someone else", Toast.LENGTH_SHORT).show();
            }
