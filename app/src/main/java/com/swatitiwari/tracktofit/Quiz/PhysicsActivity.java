...
public class PhysicsActivity extends AppCompatActivity {
    ...
    String doBetter = "You can do better! Need to be updated" + System.getProperty("line.separator") + System.getProperty("line.separator") + "Try again?";
    String poor = "Brush up your knowledge, and try again?";
    String congrats = "Well done!" + System.getProperty("line.separator") + System.getProperty("line.separator") + "You are awesome, you have great knowledge about food and calories, Bravo!!!!!!";
    // Question 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PhysicsActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //------------------------------------------------------------------------------------------
                if (question2_choice4.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 3 - Correct Answer is #1 and #2
                //------------------------------------------------------------------------------------------
                if (question3_choice2.isChecked() && question3_choice2.isChecked() && question3_choice3.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 4 - Correct Answer is Stephen Hawking
                //------------------------------------------------------------------------------------------
                if (question4_answer.getText().toString().toLowerCase().equals("18"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                //------------------------------------------------------------------------------------------
                if (question6_answer.getText().toString().toLowerCase().equals("true"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                //------------------------------------------------------------------------------------------
                //------------------------------------------------------------------------------------------
                if (question8_answer.getText().toString().toLowerCase().equals("sunlight"))
                    final_score++;
                //------------------------------------------------------------------------------------------
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Hey! Love Quizzes? My highscore is " + final_score + " on Awareness regarding food\nCan you beat me?\nDownload the app from github_sword9901";
