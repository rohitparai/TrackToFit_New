...
public class ChemistryActivity extends AppCompatActivity {
    ...
    String doBetter = "You can do better! its necessary to know about mental health" + System.getProperty("line.separator") + System.getProperty("line.separator") + "Try again?";
    String poor = "Brush up your knowledge,awareness about mental health is too important.";
    String congrats = "Well done!" + System.getProperty("line.separator") + "You are awesome, please spread awareness more!!!";
    // Question 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChemistryActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (question1_choice1.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 2 - Correct Answer is #3
                //------------------------------------------------------------------------------------------
                if (question2_choice3.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 3 - Correct Answer is #2
                //------------------------------------------------------------------------------------------
                if (question3_choice2.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 4 - Correct Answer is Dmitri Mendeleev
                //------------------------------------------------------------------------------------------
                if (question4_answer.getText().toString().toLowerCase().equals("men"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Question 5 - Correct Answer is #1
                //------------------------------------------------------------------------------------------
                ...
                //------------------------------------------------------------------------------------------
                if (question6_answer.getText().toString().toLowerCase().equals("yes"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                //------------------------------------------------------------------------------------------
                if (question8_answer.getText().toString().toLowerCase().equals("yes"))
                    final_score++;
                //------------------------------------------------------------------------------------------
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Hey! fitness freeks? My highscore is " + final_score + " on mental healtrh awareness \nCan you beat me?\nDownload the app from github@sword99001";
