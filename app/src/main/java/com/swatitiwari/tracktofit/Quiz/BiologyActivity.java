...
import com.swatitiwari.tracktofit.Activities.UserDashboard;
import com.swatitiwari.tracktofit.R;

public class BiologyActivity extends AppCompatActivity {

    String doBetter = "you are better...keep exploring.....bravo!!!" + System.getProperty("line.separator") + System.getProperty("line.separator") + "Try again?";
    String poor = "Brush up your knowledge,Health is on your way?";
    String congrats = "You're a beast!!You’re no stranger to the gym, and you’re most likely the master of intense workout routines. Keep up the good work!" + System.getProperty("line.separator") + "You are awesome!";
    // Question 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //------------------------------------------------------------------------------------------
                if (question4_answer.getText().toString().toLowerCase().equals("yes"))
                    final_score++;
                //----------------------------------------------------------------------------------------
                // Question 5 - Correct Answer is #1, #2 and #3
                //------------------------------------------------------------------------------------------
                if (question5_choice1.isChecked() && question5_choice3.isChecked())
                    final_score++;
                //------------------------------------------------------------------------------------------
                // Que
                //------------------------------------------------------------------------------------------
                if (question6_answer.getText().toString().toLowerCase().equals("no"))
                    final_score++;
                //------------------------------------------------------------------------------------------
                ...
                //------------------------------------------------------------------------------------------
                if (question10_choice1.isChecked())
                    final_score++;
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Hey! Love Quizzes? My highscore is " + final_score + " Hey fam I am fitness beast \nCan you beat me?\nDownload the app from github@sword9901";
