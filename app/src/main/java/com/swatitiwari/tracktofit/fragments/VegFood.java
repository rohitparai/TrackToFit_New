...
public class VegFood extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_food_suggestion, container, false);
        ...
        RecyclerView recyclerView =view.findViewById(R.id.recycler_view_veg);
